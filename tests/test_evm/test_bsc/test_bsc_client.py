...
), "Please provide TEST_BSC_WALLET_PRIVATE_KEY"
...
async def test_get_balance(
    bsc_client: AioTxBSCClient, wallet_address, expected_exception, expected_balance
):
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "0x6007710c9bc82da8a9cb6104e39fef7b259df0d257a0efcf46908b9451909111",
            TransactionNotFound,
        ),
        (
            "0x6007710c9bc82da8a9cb6104e39fef7b259df0d257a0efcf46908b945190911",
            InvalidArgumentError,
        ),
        (
            "41c8e2e03195c29cea37d67ad234d91c52258a514c78f9fcfd196aa5992209ae",
            InvalidArgumentError,
        ),
    ],
)
...
async def test_get_transaction_count(
    bsc_client: AioTxBSCClient, wallet_address, expected_exception, expected_count
):
    if expected_exception:
        with pytest.raises(expected_exception):
...
async def test_get_contract_decimals(
    bsc_client: AioTxBSCClient, contract, expected_decimals, expected_exception
):
    if expected_exception:
        with pytest.raises(expected_exception):
